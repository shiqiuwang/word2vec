...
from Skip_Gram_NGE.skip_gram_nge_model import SkipGramModel
from Skip_Gram_NGE.input_data import InputData
import torch.optim as optim
from tqdm import tqdm
import torch
import Skip_Gram_NGE.argumentparser as argumentparser
    ...
    def train(self):
        ...
        for _ in range(1, EPOCH + 1):
            ...
            for i in process_bar:
                ...
                process_bar.update()
        torch.save(self.model.state_dict(), "../results/url_with_location.pkl")
        self.model.save_embedding(self.data.id2word_dict, self.output_file_name)


if __name__ == '__main__':
    w2v = Word2Vec(input_file_name='../data/dataset_tokens.csv', output_file_name="../results/datasets_tokens.txt")
    w2v.train()
    # w2v = Word2Vec(input_file_name='../data/url_with_location.txt',
    #                output_file_name="../results/url_with_locaion_skip_gram_neg.txt")
    # w2v.train()
