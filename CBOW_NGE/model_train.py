    ...
    def train(self):
        for _ in range(1, EPOCH + 1):
            ...
            for i in process_bar:
                ...
                process_bar.update()
            print('\n')
        torch.save(self.model.state_dict(), "../results/url_with_location_cbow_neg.pkl")
...
if __name__ == '__main__':
    w2v = Word2Vec(input_file_name='../data/url_with_location.txt',
                   output_file_name="../results/url_with_location_cbow_neg.txt")
    # for _ in range(1,EPOCH+1):
    w2v.train()
    # w2v = Word2Vec(input_file_name='../data/text8.txt', output_file_name="../results/text8_cbow_neg.txt")
    # w2v.train()
